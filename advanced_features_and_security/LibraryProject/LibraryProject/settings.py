...
SECRET_KEY = 'django-insecure-g^9xl^l5!n85=a7!(pp811*iv-iyqxki!4rzgr+=m38b8pkcjb'
...
# CSRF cookie should only be sent over HTTPS
CSRF_COOKIE_SECURE = True

# Session cookie should only be sent over HTTPS
